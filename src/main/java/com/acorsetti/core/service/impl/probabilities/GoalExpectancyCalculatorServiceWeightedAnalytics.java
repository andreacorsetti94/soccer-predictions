...
@Service("GoalExpectancyCalculatorServiceWeightedAnalytics")
public class GoalExpectancyCalculatorServiceWeightedAnalytics implements GoalExpectancyCalculatorService {

    private static final Logger logger = Logger.getLogger(GoalExpectancyCalculatorServiceWeightedAnalytics.class);
